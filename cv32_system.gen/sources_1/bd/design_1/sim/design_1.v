...
//Date        : Thu May 21 03:19:19 2026
//Host        : LAPTOP-QMVEKFV7 running 64-bit major release  (build 9200)
...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=18,da_board_cnt=2,da_bram_cntlr_cnt=6,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [1:0]axi_smc_M04_AXI_ARLOCK;
  ...
  wire [1:0]axi_smc_M04_AXI_AWLOCK;
  ...
  wire [63:0]axi_smc_M04_AXI_RDATA;
  wire axi_smc_M04_AXI_RLAST;
  wire axi_smc_M04_AXI_RREADY;
  wire [1:0]axi_smc_M04_AXI_RRESP;
  wire axi_smc_M04_AXI_RVALID;
  wire [63:0]axi_smc_M04_AXI_WDATA;
  wire axi_smc_M04_AXI_WLAST;
  wire axi_smc_M04_AXI_WREADY;
  wire [7:0]axi_smc_M04_AXI_WSTRB;
  wire axi_smc_M04_AXI_WVALID;
  wire [31:0]blk_mem_gen_0_doutb;
  wire [31:0]blk_mem_gen_1_doutb;
  wire [31:0]cv32_bram_top_0_bram_data_addra;
  wire [31:0]cv32_bram_top_0_bram_data_dina;
  wire cv32_bram_top_0_bram_data_ena;
  wire [3:0]cv32_bram_top_0_bram_data_wea;
  wire [31:0]cv32_bram_top_0_bram_inst_addra;
  wire cv32_bram_top_0_bram_inst_ena;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(cv32_bram_top_0_bram_inst_addra),
        ...
        .enb(cv32_bram_top_0_bram_inst_ena),
  ...
  design_1_blk_mem_gen_1_0 blk_mem_gen_1
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_1_BRAM_PORTA_ADDR}),
        .addrb(cv32_bram_top_0_bram_data_addra),
        .clka(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .clkb(processing_system7_0_FCLK_CLK0),
        .dina(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .dinb(cv32_bram_top_0_bram_data_dina),
        .douta(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_1_doutb),
        .ena(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .enb(cv32_bram_top_0_bram_data_ena),
        .rsta(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .rstb(1'b0),
        .wea(axi_bram_ctrl_1_BRAM_PORTA_WE),
        .web(cv32_bram_top_0_bram_data_wea));
  design_1_cv32_bram_top_0_0 cv32_bram_top_0
       (.bram_data_addra(cv32_bram_top_0_bram_data_addra),
        .bram_data_dina(cv32_bram_top_0_bram_data_dina),
        .bram_data_douta(blk_mem_gen_1_doutb),
        .bram_data_ena(cv32_bram_top_0_bram_data_ena),
        .bram_data_wea(cv32_bram_top_0_bram_data_wea),
        .bram_inst_addra(cv32_bram_top_0_bram_inst_addra),
        .bram_inst_douta(blk_mem_gen_0_doutb),
        .bram_inst_ena(cv32_bram_top_0_bram_inst_ena),
        .clk_i(processing_system7_0_FCLK_CLK0),
        .fetch_enable_i(axi_gpio_0_gpio2_io_o),
        .rst_ni(axi_gpio_0_gpio_io_o));
  ...
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr[14:0]),
        ...
        .S_AXI_HP0_ARADDR(axi_smc_M04_AXI_ARADDR),
        .S_AXI_HP0_ARBURST(axi_smc_M04_AXI_ARBURST),
        .S_AXI_HP0_ARCACHE(axi_smc_M04_AXI_ARCACHE),
        .S_AXI_HP0_ARID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_ARLEN(axi_smc_M04_AXI_ARLEN),
        .S_AXI_HP0_ARLOCK(axi_smc_M04_AXI_ARLOCK),
        .S_AXI_HP0_ARPROT(axi_smc_M04_AXI_ARPROT),
        .S_AXI_HP0_ARQOS(axi_smc_M04_AXI_ARQOS),
        .S_AXI_HP0_ARREADY(axi_smc_M04_AXI_ARREADY),
        .S_AXI_HP0_ARSIZE(axi_smc_M04_AXI_ARSIZE),
        .S_AXI_HP0_ARVALID(axi_smc_M04_AXI_ARVALID),
        .S_AXI_HP0_AWADDR(axi_smc_M04_AXI_AWADDR),
        .S_AXI_HP0_AWBURST(axi_smc_M04_AXI_AWBURST),
        .S_AXI_HP0_AWCACHE(axi_smc_M04_AXI_AWCACHE),
        .S_AXI_HP0_AWID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_AWLEN(axi_smc_M04_AXI_AWLEN),
        .S_AXI_HP0_AWLOCK(axi_smc_M04_AXI_AWLOCK),
        .S_AXI_HP0_AWPROT(axi_smc_M04_AXI_AWPROT),
        .S_AXI_HP0_AWQOS(axi_smc_M04_AXI_AWQOS),
        .S_AXI_HP0_AWREADY(axi_smc_M04_AXI_AWREADY),
        .S_AXI_HP0_AWSIZE(axi_smc_M04_AXI_AWSIZE),
        .S_AXI_HP0_AWVALID(axi_smc_M04_AXI_AWVALID),
        .S_AXI_HP0_BREADY(axi_smc_M04_AXI_BREADY),
        .S_AXI_HP0_BRESP(axi_smc_M04_AXI_BRESP),
        .S_AXI_HP0_BVALID(axi_smc_M04_AXI_BVALID),
        .S_AXI_HP0_RDATA(axi_smc_M04_AXI_RDATA),
        .S_AXI_HP0_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP0_RLAST(axi_smc_M04_AXI_RLAST),
        .S_AXI_HP0_RREADY(axi_smc_M04_AXI_RREADY),
        .S_AXI_HP0_RRESP(axi_smc_M04_AXI_RRESP),
        .S_AXI_HP0_RVALID(axi_smc_M04_AXI_RVALID),
        .S_AXI_HP0_WDATA(axi_smc_M04_AXI_WDATA),
        .S_AXI_HP0_WID({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S_AXI_HP0_WLAST(axi_smc_M04_AXI_WLAST),
        .S_AXI_HP0_WREADY(axi_smc_M04_AXI_WREADY),
        .S_AXI_HP0_WRISSUECAP1_EN(1'b0),
        .S_AXI_HP0_WSTRB(axi_smc_M04_AXI_WSTRB),
